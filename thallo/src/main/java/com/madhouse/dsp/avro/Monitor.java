...
public class Monitor extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Monitor(java.util.List<com.madhouse.dsp.avro.Track> impurl, java.util.List<CharSequence> clkurl, java.util.List<CharSequence> securl, Integer exptime, java.util.List<CharSequence> exts) {
    this.impurl = impurl;
    this.clkurl = clkurl;
    this.securl = securl;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Monitor>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.Monitor.Builder setClkurl(java.util.List<CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.Monitor.Builder setSecurl(java.util.List<CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.Monitor.Builder setExts(java.util.List<CharSequence> value) {
