...
public class MediaBid extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MediaBid(java.lang.Long time, java.lang.CharSequence ua, java.lang.CharSequence ip, java.lang.Integer status, com.madhouse.dsp.avro.MediaRequest request, com.madhouse.dsp.avro.MediaResponse response) {
    this.time = time;
    this.ua = ua;
    this.ip = ip;
    this.status = status;
   ...
   */
  public static com.madhouse.dsp.avro.MediaBid.Builder newBuilder() {
    return new com.madhouse.dsp.avro.MediaBid.Builder();
  }
   ...
   * @return A new MediaBid RecordBuilder
   */
  public static com.madhouse.dsp.avro.MediaBid.Builder newBuilder(com.madhouse.dsp.avro.MediaBid.Builder other) {
    return new com.madhouse.dsp.avro.MediaBid.Builder(other);
  }
   ...
   * @return A new MediaBid RecordBuilder
   */
  public static com.madhouse.dsp.avro.MediaBid.Builder newBuilder(com.madhouse.dsp.avro.MediaBid other) {
    return new com.madhouse.dsp.avro.MediaBid.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MediaBid>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.madhouse.dsp.avro.MediaBid.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.madhouse.dsp.avro.MediaBid other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder setUa(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder clearUa() {
      ua = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder setIp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder clearIp() {
      ip = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder setStatus(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder clearStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder setRequest(com.madhouse.dsp.avro.MediaRequest value) {
     ...
     * @return This builder.
     */
    public com.madhouse.dsp.avro.MediaBid.Builder setRequestBuilder(com.madhouse.dsp.avro.MediaRequest.Builder value) {
      clearRequest();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder clearRequest() {
      request = null;
      requestBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder setResponse(com.madhouse.dsp.avro.MediaResponse value) {
     ...
     * @return This builder.
     */
    public com.madhouse.dsp.avro.MediaBid.Builder setResponseBuilder(com.madhouse.dsp.avro.MediaResponse.Builder value) {
      clearResponse();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.MediaBid.Builder clearResponse() {
      response = null;
