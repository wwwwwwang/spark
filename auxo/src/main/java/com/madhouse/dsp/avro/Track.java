...
public class Track extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Track(java.lang.Integer startdelay, java.lang.CharSequence url) {
   ...
   */
  public static com.madhouse.dsp.avro.Track.Builder newBuilder() {
    return new com.madhouse.dsp.avro.Track.Builder();
  }
   ...
   * @return A new Track RecordBuilder
   */
  public static com.madhouse.dsp.avro.Track.Builder newBuilder(com.madhouse.dsp.avro.Track.Builder other) {
    return new com.madhouse.dsp.avro.Track.Builder(other);
  }
   ...
   * @return A new Track RecordBuilder
   */
  public static com.madhouse.dsp.avro.Track.Builder newBuilder(com.madhouse.dsp.avro.Track other) {
    return new com.madhouse.dsp.avro.Track.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Track>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.madhouse.dsp.avro.Track.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.madhouse.dsp.avro.Track other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.startdelay)) {
        this.startdelay = data().deepCopy(fields()[0].schema(), other.startdelay);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.Track.Builder setStartdelay(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.Track.Builder clearStartdelay() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.Track.Builder setUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.madhouse.dsp.avro.Track.Builder clearUrl() {
      url = null;
