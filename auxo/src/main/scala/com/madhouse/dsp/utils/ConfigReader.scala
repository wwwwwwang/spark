...
object ConfigReader extends Serializable {
  ...
  var defaultHdfsPath = "/travelmad/apps/auxo"
  ...
  val requestTriggerTimeMS: Long = getWithElse("request.trigger_processing_time_ms", 3000)
  ...
  val impTriggerTimeMS: Int = getWithElse("imp.trigger_processing_time_ms", 3000)
  ...
  val clkTriggerTimeMS: Int = getWithElse("clk.trigger_processing_time_ms", 3000)
